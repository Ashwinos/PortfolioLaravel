    ...
    <div class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
        <div class="mr-auto place-self-center lg:col-span-7">
            <h1
                ...
                Web design <br>Git Hub Repositories
            </h1>
...
<div class="container" style="padding-left: 50px;">
  <div class="my-10 max-w-xl rounded-xl px-6 py-10 text-gray-600 shadow text-left ml-0" >
    <div class="mb-4 w-20 rounded-md bg-blue-100 px-2 py-1 text-sm font-medium text-blue-700">Feature</div>
    <p class="mb-2 text-2xl">Basic Portfolio Website</p>
    <p class="mb-6 text-gray-400">Designed and Developed a Personal Portfolio Website: Utilized HTML and CSS to create a visually appealing and responsive website to showcase my work, skills, and projects.</p>
