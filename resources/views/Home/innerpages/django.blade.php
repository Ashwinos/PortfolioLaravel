    ...
    <div class="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
        <div class="mr-auto place-self-center lg:col-span-7">
            <h1
                ...
                Python Django <br>Git Hub Repositories
            </h1>

            <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
              Proficient in using Git and GitHub for version control, ensuring seamless collaboration and efficient tracking of changes across multiple projects.
                
            </p>

            <div class="space-y-4 sm:flex sm:space-y-0 sm:space-x-4">

                <a href="https://github.com/Ashwinos" target="_blank"
        ...
        <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
            <img src="{{asset('images/github.png')}}" alt="hero image">
        </div>
...
<div class="container" style="display: flex;">
    <div class="mx-auto my-10 max-w-sm rounded-sm px-6 py-10 text-gray-600 shadow" style="align-items:left;">
    <div class="mb-4 w-20 rounded-md bg-blue-100 px-2 py-1 text-sm font-medium text-blue-700">Feature</div>
    <p class="mb-2 text-2xl">Movie List Website</p>
    <p class="mb-6 text-gray-400">Extensive movie database with detailed information on each movie.
        Admin panel for adding and managing movie entries. User authentication and authorization</p>
    <a href="https://github.com/Ashwinos/Movies.git">
  ...
  <div class="mx-auto my-10 max-w-sm rounded-sm px-6 py-10 text-gray-600 shadow" style="align-items:left">
    <div class="mb-4 w-20 rounded-md bg-blue-100 px-2 py-1 text-sm font-medium text-blue-700">Feature</div>
    <p class="mb-2 text-2xl">Ecommerce Website</p>
    <p class="mb-6 text-gray-400">User authentication and authorization (registration, login, logout).
        Product catalog with category and product detail pages.
        Shopping cart and order management system.
        
    </p>
    <a href="https://github.com/Ashwinos/ecommerce.git">
      <button class="flex items-center space-x-2 rounded-md border-2 border-blue-500 px-4 py-2 font-medium text-blue-600 transition hover:bg-blue-500 hover:text-white">
        Git Hub
      </button>
  </a>
  ...
  <div class="mx-auto my-10 max-w-sm rounded-sm px-6 py-10 text-gray-600 shadow" style="align-items:left">
    <div class="mb-4 w-20 rounded-md bg-blue-100 px-2 py-1 text-sm font-medium text-blue-700">Feature</div>
    <p class="mb-2 text-2xl">Travel Website Project</p>
    <p class="mb-6 text-gray-400">User registration and login system.
        Destination listings with detailed information and images.
        Booking system for travel packages and accommodations
       </p>
    <a href="https://github.com/Ashwinos/Travelproject.git">
      <button class="flex items-center space-x-2 rounded-md border-2 border-blue-500 px-4 py-2 font-medium text-blue-600 transition hover:bg-blue-500 hover:text-white">
        Git Hub
      </button>
  </a>
